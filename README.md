...
| `npm test` | unit and integration tests (487, plus more when `samples/` is present) |
...
487 tests covering text normalisation and alias resolution, header detection and
