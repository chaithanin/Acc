...
| `npm test` | unit and integration tests (490, plus more when `samples/` is present) |
...
490 tests covering text normalisation and alias resolution, header detection and
