...
| `npm test` | unit and integration tests (483, plus more when `samples/` is present) |
...
483 tests covering text normalisation and alias resolution, header detection and
