...
export const KPI_DEFINITIONS: Record<string, KpiDefinition> = {
  ...
  operating_cash_flow: {
    meaning: 'Cash the business generated by trading in the report month.',
    readsFrom:
      'Collections in the month less operating payments in the month. A developer’s construction spend is operating: building the units it sells is what the business does, and the units are inventory rather than fixed assets.',
    excludes: 'Land and capital purchases, which are investing.',
  },
  investing_cash_flow: {
    meaning: 'Cash spent on assets the business keeps rather than sells.',
    readsFrom: 'Payments in the month against the land and capital expense categories.',
  },
  financing_cash_flow: {
    meaning: 'Cash from lenders and shareholders, and cash returned to them.',
    readsFrom:
      'Nothing yet: no loan, dividend or capital record is imported. Reported as not calculable rather than zero, which would claim the company neither borrowed nor repaid.',
  },
  current_assets: {
    meaning: 'What the company holds that will turn into cash within the year.',
    readsFrom: 'Bank balances, receivables outstanding, advances and deposits, and work in progress.',
    excludes:
      'Land and buildings held for development, which the imports do not carry, so this is the working-capital half of a balance sheet rather than a statutory one.',
  },
  current_liabilities: {
    meaning: 'What the company must settle within the year.',
    readsFrom: 'Vendor payables, construction certified and unpaid, and payments already committed.',
  },
  working_capital: {
    meaning:
      'The headroom to fund the business before a facility is needed. Negative means today’s obligations exceed today’s assets.',
    readsFrom: 'Derived: current assets less current liabilities.',
  },
  total_owed: {
